import { BadgeCheck, GraduationCap, Laptop } from 'lucide-react';
      ...
      <section id="sobre-mi" className="pt-12 pb-24 px-4 sm:px-6 lg:px-8 bg-[#e8ddd0] dark:bg-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-left mb-1">
            ...
            <h2 className="text-slate-900 dark:text-white mb-4 text-5xl" style={{ fontFamily: "'Playfair Display', serif" }}>Who I Am</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 shadow-lg">
              <h3 className="text-slate-900 dark:text-white mb-8 text-3xl" style={{ fontFamily: "'Playfair Display', serif" }}>Experience</h3>
              <div className="space-y-8">
                <div className="relative pl-6 border-l-2 border-slate-200 dark:border-slate-600">
                  ...
                  <p className="text-sm font-mono text-[#c4522a] dark:text-[#e8856a] mb-2">Solvd Inc. — 2024 (Internship)</p>
                ...
                <div className="relative pl-6 border-l-2 border-slate-200 dark:border-slate-600">
                  ...
                  <p className="text-sm font-mono text-[#c4522a] dark:text-[#e8856a] mb-2">Balanza — 2023–2025</p>
      ...
      <section id="education" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#f0c4a8] dark:bg-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-left mb-16">
            ...
            <h2 className="text-slate-900 dark:text-white mb-4 text-5xl" style={{ fontFamily: "'Playfair Display', serif" }}>Education & Certifications</h2>
            <div className="h-1 w-20 bg-gradient-to-r from-[#5C3317] to-[#8B4513] rounded-full" />
          </div>
          ...
          <div className="bg-white/60 dark:bg-slate-700/50 rounded-2xl p-8 border border-slate-200 dark:border-slate-600 shadow-lg mb-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#e8f0e8] dark:bg-slate-700 flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#e8f0e8] dark:bg-slate-700 flex items-center justify-center flex-shrink-0">
                  <Laptop className="text-slate-600 dark:text-slate-300" size={20} />
                </div>
                <div>
          ...
          <div id="certifications" className="bg-white/60 dark:bg-slate-700/50 rounded-2xl p-8 border border-slate-200 dark:border-slate-600 shadow-lg">
            <h3 className="text-slate-900 dark:text-white mb-8 flex items-center gap-3">
              <div className="w-1 h-8 bg-gradient-to-b from-[#5C3317] to-[#8B4513] rounded-full" />
              Certifications
            </h3>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="flex items-start gap-3 p-4 rounded-xl bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600">
                  ...
                  <div className="flex-1">
                    ...
                    {cert.url && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 mt-3 px-4 py-1.5 text-xs font-medium rounded-full border border-[#c4522a]/40 bg-[#fdf5f2] hover:bg-[#fae8e0] text-[#c4522a] dark:bg-slate-600 dark:border-[#e8856a]/40 dark:text-[#e8856a] transition-colors"
                      >
                        View Certificate →
                      </a>
                    )}
