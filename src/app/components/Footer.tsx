        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-white">Julieta Bucci</h3>
                <p className="text-slate-400 text-sm">Software Engineer</p>
              </div>
            </div>
            <p className="text-slate-400 leading-relaxed mb-6">
              Software Engineer specialized in scalable architectures,
              full stack development, and high-performance system optimization.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="#inicio" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Home
              </a>
              <a href="#sobre-mi" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                About me
              </a>
              <a href="#habilidades" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Skills
              </a>
              <a href="#proyectos" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Projects
              </a>
              <a href="#contacto" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                Contact
              </a>
            </div>
          </div>
